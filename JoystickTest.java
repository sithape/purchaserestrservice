...
public class JoystickTest {
    ...
    {
        // Creates controller
        JInputJoystick joystick = new JInputJoystick(Controller.Type.STICK, Controller.Type.KEYPAD);
        ...
        // Change name for axis.
        if(joystick.getControllerType() == Controller.Type.KEYPAD)
        {
